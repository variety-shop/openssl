...
X509_STORE_CTX_akamai_set0_store, X509_STORE_CTX_set_cert,
...
=head1 SYNOPSIS
 ...
 void X509_STORE_CTX_akamai_set0_trusted_stack(X509_STORE_CTX *ctx, X509_STORE *store);
...
X509_STORE_CTX_akamai_set0_store() sets the certificate store of B<ctx> to
