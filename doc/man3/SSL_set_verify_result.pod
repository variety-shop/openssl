...
=head1 SYNOPSIS
 ...
 void SSL_SESSION_set_verify_result(SSL_SESSION *ss, long verify_result);
...
SSL_SESSION_set_verify_result() sets B<verify_result> of the object B<ss> to be
the result of the verification of the X509 certificate presented by the peer,
if any.
...
(in addition to SSL_set_verify_result()).
