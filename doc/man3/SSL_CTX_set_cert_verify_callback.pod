...
=head1 SYNOPSIS
 ...
 void SSL_CTX_set_cert_verify_callback(SSL_CTX *ctx,
                                       ...
                                       void *arg);
 void SSL_set_cert_verify_callback(SSL *ssl,
                                   int (*callback)(X509_STORE_CTX *,void *),
                                   void *arg);
...
I<ssl>. This overrides any setting in the SSL_CTX set by
SSL_CTX_set_cert_verify_callback().

SSL_get_cert_verify_arg() returns the B<arg> set in SSL_set_cert_verify_callback();
