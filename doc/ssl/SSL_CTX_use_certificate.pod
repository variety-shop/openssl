...
SSL_CTX_use_certificate, SSL_CTX_use_certificate_ASN1, SSL_CTX_use_certificate_file, SSL_use_certificate, SSL_use_certificate_ASN1, SSL_use_certificate_file, SSL_CTX_use_certificate_chain_file, SSL_CTX_use_PrivateKey, SSL_CTX_use_cert_and_key, SSL_CTX_use_PrivateKey_ASN1, SSL_CTX_use_PrivateKey_file, SSL_CTX_use_RSAPrivateKey, SSL_CTX_use_RSAPrivateKey_ASN1, SSL_CTX_use_RSAPrivateKey_file, SSL_use_PrivateKey_file, SSL_use_PrivateKey_ASN1, SSL_use_PrivateKey, SSL_use_cert_and_key, SSL_use_RSAPrivateKey, SSL_use_RSAPrivateKey_ASN1, SSL_use_RSAPrivateKey_file, SSL_CTX_check_private_key, SSL_check_private_key - load certificate and key data
...
=head1 SYNOPSIS
 ...
 int SSL_CTX_use_cert_and_key(SSL_CTX *ctx, X509 *x, EVP_PKEY *pkey, STACK_OF(X509) *extra, int override);
 ...
 int SSL_use_cert_and_key(SSL *ssl, X509 *x, EVP_PKEY *pkey, STACK_OF(X509) *extra, int override);
...
certificate, B<pkey> private key, and B<extra> certificates onto the corresponding
B<ssl> or B<ctx>. The B<x> and B<pkey> arguments must match each
other. If the  B<override> argument is 0, then B<x>, B<pkey> and B<extra>
are set only if all were not previously set. If B<override> is non-0, then the
certificate, private key and extra certs are always set. If B<pkey> is NULL,
...
on success of replacing an existing certificate/private key (B<override> is set)
