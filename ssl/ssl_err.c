...
static ERR_STRING_DATA SSL_str_functs[] = {
    ...
    {ERR_FUNC(SSL_F_SSL_CHECK_CLIENTHELLO_TLSEXT_EARLY),
    ...
    {ERR_FUNC(SSL_F_SSL_INTERNAL_BYTES_TO_CIPHER_LIST),
     "ssl_internal_bytes_to_cipher_list"},
    ...
    {ERR_FUNC(SSL_F_SSL_READV), "SSL_readv"},
    ...
    {ERR_FUNC(SSL_F_SSL_USE_CERT_AND_KEY), "SSL_use_cert_and_key"},
    ...
    {ERR_FUNC(SSL_F_SSL_WRITEV), "SSL_writev"},
...
static ERR_STRING_DATA SSL_str_reasons[] = {
    ...
    {ERR_REASON(SSL_R_BUCKET_COPY_FAILED), "bucket copy failed"},
    ...
    {ERR_REASON(SSL_R_READV_IN_PROGRESS), "readv in progress"},
    {ERR_REASON(SSL_R_READV_NO_DTLS), "readv no dtls"},
    ...
    {ERR_REASON(SSL_R_UNABLE_TO_COPY), "unable to copy"},
    ...
    {ERR_REASON(SSL_R_WRITEV_IN_PROGRESS), "writev in progress"},
    {ERR_REASON(SSL_R_WRITEV_NO_DTLS), "writev no dtls"},
