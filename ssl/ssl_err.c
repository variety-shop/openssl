...
static const ERR_STRING_DATA SSL_str_functs[] = {
    ...
    {ERR_PACK(ERR_LIB_SSL, SSL_F_SSL_CTX_USE_CERTIFICATE_CHAIN_BIO, 0),
     "ssl_ctx_use_certificate_chain_bio"},
    {ERR_PACK(ERR_LIB_SSL, SSL_F_SSL_CTX_USE_CERTIFICATE_CHAIN_MEM, 0),
     "SSL_CTX_use_certificate_chain_mem"},
    {ERR_PACK(ERR_LIB_SSL, SSL_F_SSL_CTX_USE_CERTIFICATE_FILE, 0),
     "SSL_CTX_use_certificate_file"},
    {ERR_PACK(ERR_LIB_SSL, SSL_F_SSL_CTX_USE_CERT_AND_KEY, 0),
    ...
    {ERR_PACK(ERR_LIB_SSL, SSL_F_SSL_READV, 0), "SSL_readv"},
    ...
    {ERR_PACK(ERR_LIB_SSL, SSL_F_SSL_USE_CERT_AND_KEY, 0),
    ...
    {ERR_PACK(ERR_LIB_SSL, SSL_F_SSL_WRITEV, 0), "SSL_writev"},
...
static const ERR_STRING_DATA SSL_str_reasons[] = {
    ...
    {ERR_PACK(ERR_LIB_SSL, 0, SSL_R_BUCKET_COPY_FAILED), "bucket copy failed"},
    ...
    {ERR_PACK(ERR_LIB_SSL, 0, SSL_R_READV_IN_PROGRESS), "readv in progress"},
    {ERR_PACK(ERR_LIB_SSL, 0, SSL_R_READV_NO_DTLS), "readv no dtls"},
    ...
    "too much early data"},
    {ERR_PACK(ERR_LIB_SSL, 0, SSL_R_UNABLE_TO_COPY), "unable to copy"},
    ...
    {ERR_PACK(ERR_LIB_SSL, 0, SSL_R_WRITEV_IN_PROGRESS), "writev in progress"},
    {ERR_PACK(ERR_LIB_SSL, 0, SSL_R_WRITEV_NO_DTLS), "writev no dtls"},
