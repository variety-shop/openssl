...
static const ERR_STRING_DATA SSL_str_functs[] = {
    ...
    {ERR_PACK(ERR_LIB_SSL, SSL_F_SSL_GET1_PREVIOUS_CLIENT_SESSION, 0),
     "SSL_get1_previous_client_session"},
    ...
    {ERR_PACK(ERR_LIB_SSL, SSL_F_SSL_SESSION_SET1_CACHE_ID, 0),
    ...
    {ERR_PACK(ERR_LIB_SSL, SSL_F_SSL_SET1_CACHE_ID, 0), "SSL_set1_cache_id"},
