...
$P/configure.ts : CONFIGFLAGS := $(CONFIGFLAGS) --strict-warnings akamai-linux-x86_64-alsi7$(strip $($P/OPENSSL_BUILDENV_NO_FOMIT_FRAME_POINTER_OPTION))
else # AKAMAKE-LINUX-BUILD-64
$P/configure.ts : CONFIGFLAGS := $(CONFIGFLAGS) --strict-warnings akamai-linux-i686-alsi7$(strip $($P/OPENSSL_BUILDENV_NO_FOMIT_FRAME_POINTER_OPTION))
...
ifdef AKAMAKE-LINUX-BUILD-64
$P/configure.ts : CONFIGFLAGS := $(CONFIGFLAGS) --strict-warnings akamai-linux-x86_64-alsi8$(strip $($P/OPENSSL_BUILDENV_NO_FOMIT_FRAME_POINTER_OPTION))
else # AKAMAKE-LINUX-BUILD-64
$P/configure.ts : CONFIGFLAGS := $(CONFIGFLAGS) --strict-warnings akamai-linux-i686-alsi8$(strip $($P/OPENSSL_BUILDENV_NO_FOMIT_FRAME_POINTER_OPTION))
endif # AKAMAKE-LINUX-BUILD-64
...
ifdef AKAMAKE-LINUX-BUILD-64
$P/configure.ts : CONFIGFLAGS := $(CONFIGFLAGS) --strict-warnings akamai-linux-x86_64-alsi9$(strip $($P/OPENSSL_BUILDENV_NO_FOMIT_FRAME_POINTER_OPTION))
else # AKAMAKE-LINUX-BUILD-64
$P/configure.ts : CONFIGFLAGS := $(CONFIGFLAGS) --strict-warnings akamai-linux-i686-alsi9$(strip $($P/OPENSSL_BUILDENV_NO_FOMIT_FRAME_POINTER_OPTION))
endif # AKAMAKE-LINUX-BUILD-64
...
ifeq ($(KERNEL_BITS),64)
$P/configure.ts : CONFIGFLAGS := $(CONFIGFLAGS) darwin64-x86_64-cc
else # ifeq ($(KERNEL_BITS),64)
$P/configure.ts : CONFIGFLAGS := $(CONFIGFLAGS) darwin-i386-cc
...
$P/configure.ts : CONFIGFLAGS := $(CONFIGFLAGS) VC-WIN64A no-asm
else # ifdef AKAMAKE-WIN64-BUILD
$P/configure.ts : CONFIGFLAGS := $(CONFIGFLAGS) VC-WIN32 no-asm
...
$P/configure.ts : CONFIGFLAGS := $(CONFIGFLAGS) -DPURIFY
endif # ifneq ($(filter ccmalloc,$(MAKECMDGOALS)),)

ifneq ($(filter debug,$(MAKECMDGOALS)),)
$P/configure.ts : CONFIGFLAGS := $(CONFIGFLAGS) --debug
