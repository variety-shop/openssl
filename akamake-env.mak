...
# FILE OFFSET BITS
$P/configure.ts : $P/CONFIGFLAGS := $($P/CONFIGFLAGS) --strict-warnings $(filter %=64,-D_FILE_OFFSET_BITS=$(BUILDENV.FILE_OFFSET_BITS-master))
...
$P/configure.ts : $P/CONFIGFLAGS := $($P/CONFIGFLAGS) --strict-warnings akamai-linux-x86_64-alsi7$(strip $($P/OPENSSL_BUILDENV_NO_FOMIT_FRAME_POINTER_OPTION))
else # AKAMAKE-LINUX-BUILD-64
$P/configure.ts : $P/CONFIGFLAGS := $($P/CONFIGFLAGS) --strict-warnings akamai-linux-i686-alsi7$(strip $($P/OPENSSL_BUILDENV_NO_FOMIT_FRAME_POINTER_OPTION))
...
ifdef AKAMAKE-LINUX-BUILD-64
$P/configure.ts : $P/CONFIGFLAGS := $($P/CONFIGFLAGS) --strict-warnings akamai-linux-x86_64-alsi8$(strip $($P/OPENSSL_BUILDENV_NO_FOMIT_FRAME_POINTER_OPTION))
else # AKAMAKE-LINUX-BUILD-64
$P/configure.ts : $P/CONFIGFLAGS := $($P/CONFIGFLAGS) --strict-warnings akamai-linux-i686-alsi8$(strip $($P/OPENSSL_BUILDENV_NO_FOMIT_FRAME_POINTER_OPTION))
endif # AKAMAKE-LINUX-BUILD-64
...
ifdef AKAMAKE-LINUX-BUILD-64
$P/configure.ts : $P/CONFIGFLAGS := $($P/CONFIGFLAGS) --strict-warnings akamai-linux-x86_64-alsi9$(strip $($P/OPENSSL_BUILDENV_NO_FOMIT_FRAME_POINTER_OPTION))
else # AKAMAKE-LINUX-BUILD-64
$P/configure.ts : $P/CONFIGFLAGS := $($P/CONFIGFLAGS) --strict-warnings akamai-linux-i686-alsi9$(strip $($P/OPENSSL_BUILDENV_NO_FOMIT_FRAME_POINTER_OPTION))
endif # AKAMAKE-LINUX-BUILD-64
